# ProGuard rules for demo-compose application

# Keep only entry points — R8 will trace and keep what's reachable
-keep public class ru.voboost.components.demo.compose.MainActivity { *; }
...
# Suppress warnings for Compose (used in demo-compose)
